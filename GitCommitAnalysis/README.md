...
- 分析项目数量和总提交数
- 总修改文件数和活跃天数
- 项目开发强度排行（按提交数、修改文件数等）

### 项目详细分析
- **基础统计**: 提交数、修改文件数、活跃天数、平均每次提交文件数
- **单次提交修改文件数排行**: 找出修改文件最多的提交记录
- **大型提交分析**: 分析修改文件数超过10个的提交
- **文件修改频率排行**: 最常修改的文件列表
- **开发技术栈分布**: 基于文件类型分析使用的技术
- **开发活跃度时间分布**: 按日期统计的提交活跃度
- **工作习惯分析**: 工作日vs周末的开发偏好

### 个人开发习惯分析
- **开发技术栈分析**: 基于文件类型统计的技术领域分布
- **工作时间习惯**: 工作日分布和时间段偏好分析
- **月度活跃度趋势**: 按月统计的开发活跃度变化
- **大型提交汇总**: 跨项目的大型提交统计
- **高频修改文件提交排行**: 单次提交修改文件数的全局排行
